...
<script type="text/javascript">
        function RedirectServices() {
            window.location="demandesDeServices.php";
        }
...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] != "POST" && empty($_POST))
    {
            ...
            $infos = $managerOffre->lireUneDemande($idOffre);
...
?>
            ...
            <div class="tab">
                ...
                <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                    ...
                    <input style="margin-left:30%;" class="button"  id="retour" value="Retour" onclick="RedirectServices();"/>                 
                </form>
            </div>
            ...
            <div class="posterMsg">
                <?php
                    $pseudo = $_SESSION['login']; // voir si $pseudo ne serait pas mieux, càd rien ! ;)
                //echo $pseudoVisiteur;
                ...
                //var_dump($pseudoOffrant);
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST" && !empty($_POST))
                    {
                         $managerOffre->verifierEtInsererMsgDemande();
                    }
            ...
            <?php
                ...
                if ($nbMsg < 1)
                {
                    ...
                    echo " <table> ";
                    echo "   <tr>";
                    echo "     <td style='width:100px;'>".$x."</td>";                    
                    echo "     <td style='width:500px;'>Il y a pas encore de message pour cette offre...</td>";
                    echo "  </tr>";
                    echo "</table>";
                }
                else
